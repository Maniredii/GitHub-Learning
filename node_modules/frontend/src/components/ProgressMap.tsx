...
export const ProgressMap: React.FC<ProgressMapProps> = ({
  ...
  const hoveredChapter = hoveredRegion
    ? chapters.find((c) => c.id === hoveredRegion)
    : null;
    ...
    <div className="progress-map">
          ...
          return (
            <g key={regionPath.id}>
              <path
                ...
                filter={isCurrent ? 'url(#glowCurrent)' : isUnlocked ? 'url(#glowUnlocked)' : 'none'}
      ...
      {hoveredChapter && (
        ...
        >
          ...
          <div className="progress-map__tooltip-description">
