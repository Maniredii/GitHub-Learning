...
vi.mock('../Terminal', () => ({
  Terminal: ({ repositoryId }: any) => (
    <div data-testid="terminal">Terminal: {repositoryId}</div>
  ),
}));
...
describe('QuestView', () => {
  ...
  describe('Quest rendering', () => {
    ...
    it('should render quest objective', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Create a commit with a meaningful message')
        ).toBeInTheDocument();
      });
    });
  ...
  describe('Quest validation', () => {
    ...
    it('should call validation API when Check Progress is clicked', async () => {
      ...
      vi.spyOn(questApi.questApi, 'validateQuest').mockResolvedValue(
    ...
    it('should display success message on quest completion', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Great job! You created your first commit.')
        ).toBeInTheDocument();
    ...
    it('should display failure feedback when validation fails', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('No commits found. Try using git commit.')
        ).toBeInTheDocument();
      });
    });
