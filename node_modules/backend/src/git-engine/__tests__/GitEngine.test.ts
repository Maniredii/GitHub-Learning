...
describe('Remote Repository Operations', () => {
  ...
  describe('Clone Operation', () => {
    test('should clone a remote repository', () => {
      ...
      const remoteRepo = Repository.createRemoteRepository('test-repo', 'https://github.com/test/repo.git');
      const remoteEngine = new GitEngine(Repository.create({
    ...
    test('should set HEAD to main branch after clone', () => {
      const remoteRepo = Repository.createRemoteRepository('test-repo', 'https://github.com/test/repo.git');
      const remoteEngine = new GitEngine(Repository.create({ 'test.txt': { content: 'test', modified: false } }));
      remoteEngine.addAll();
      remoteEngine.commit('Initial commit');
  ...
  describe('Pull Operation', () => {
    test('should pull and merge changes from remote', () => {
      ...
      const remoteRepo = Repository.createRemoteRepository('test-repo', 'https://github.com/test/repo.git');
      const remoteEngine = new GitEngine(Repository.create({ 'test.txt': { content: 'initial', modified: false } }));
      remoteEngine.addAll();
      remoteEngine.commit('Initial commit');
  ...
  describe('Fork Operation', () => {
    test('should fork a remote repository', () => {
      ...
      const sourceRepo = Repository.createRemoteRepository('source', 'https://github.com/original/repo.git');
      const sourceEngine = new GitEngine(Repository.create({ 'test.txt': { content: 'test', modified: false } }));
      sourceEngine.addAll();
  ...
  describe('Pull Request Operations', () => {
    test('should create a pull request', () => {
      ...
      const sourceRepo = Repository.createRemoteRepository('source', 'https://github.com/user/repo.git');
      const targetRepo = Repository.createRemoteRepository('target', 'https://github.com/original/repo.git');

      // Add commits and branches
      const engine = new GitEngine(Repository.create({ 'test.txt': { content: 'test', modified: false } }));
      engine.addAll();
