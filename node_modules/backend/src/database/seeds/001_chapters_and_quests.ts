  ...
  const quests = [
    {
      ...
      title: 'The Awakening',
      narrative: 'You stand before the Ancient Library, its digital halls filled with forgotten code. A mysterious voice echoes: "Welcome, Chrono-Coder. To restore the Lost Project, you must first understand what version control truly means."',
      objective: 'Learn what Git is and why version control matters.',
      hints: JSON.stringify(['Git tracks changes to files over time', 'Version control helps teams collaborate', 'You can travel back to any point in your project history']),
      xp_reward: 50,
      order: 1,
    ...
    },
    {
      ...
      narrative: 'The voice guides you to an empty chamber. "Every journey begins with a single step. Create your first repository - a container for your project\'s history."',
      objective: 'Initialize a new Git repository.',
      hints: JSON.stringify(['Use the git init command', 'This creates a hidden .git folder', 'The repository is now ready to track changes']),
      xp_reward: 100,
      order: 2,
      validation_criteria: JSON.stringify({
        type: 'custom',
    ...
    // Chapter 1 quests
    {
      ...
      narrative: 'You enter the Caves of Commitment. Ancient runes glow on the walls, showing the command "git add". "This spell," the voice explains, "prepares your changes for preservation."',
      objective: 'Stage a file using git add.',
      hints: JSON.stringify(['Create or modify a file first', 'Use git add <filename> to stage it', 'Check git status to see staged files']),
      xp_reward: 150,
      order: 1,
      validation_criteria: JSON.stringify({
        type: 'custom',
    ...
    },
    {
      ...
      narrative: 'The cave trembles as you approach the Sealing Stone. "Now," the voice commands, "seal this moment in time with git commit. Your changes will be preserved forever."',
      objective: 'Create your first commit with a meaningful message.',
      hints: JSON.stringify(['Use git commit -m "Your message here"', 'Write a clear, descriptive message', 'This creates a snapshot of your staged changes']),
      xp_reward: 200,
      order: 2,
      validation_criteria: JSON.stringify({
        type: 'commit_exists',
    ...
    },
    {
      ...
      narrative: 'Ancient scrolls line the cave walls. "Use git log," the voice instructs, "to read the chronicles of your journey. Every commit tells a story."',
      objective: 'View your commit history using git log.',
      hints: JSON.stringify(['Simply type git log', 'You\'ll see commit hashes, authors, dates, and messages', 'Press q to exit the log view']),
      xp_reward: 100,
      order: 3,
      validation_criteria: JSON.stringify({
        type: 'custom',
        ...
        commits: [
          {
            ...
            parent: null,
            tree: { 'README.md': { content: '# My First Project\n\nThis is a test file.', modified: false } },
          },
        ],
